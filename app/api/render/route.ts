...
export async function POST(request: Request) {
  ...
  try {
    ...
    const body = new FormData(); body.append("model", process.env.OPENAI_IMAGE_MODEL || "gpt-image-1.5"); body.append("image", image); body.append("prompt", renderPrompt(fields)); body.append("quality", "high"); body.append("size", "auto"); body.append("output_format", "webp"); body.append("input_fidelity", "high");
